      ...
      <div style={{
        ...
        {success ? (
          ...
          <div>
            ...
            {/* USDT TRC20 Payment Address — shows only when USDT (TRC20) selected */}
            {form.paymentMethod === 'USDT (TRC20)' && (
              <div style={{
                background: `${C.DARK}60`, border: `1px solid ${C.GOLD}30`, borderRadius: 12,
                padding: 20, marginBottom: 20, textAlign: 'center',
              }}>
                <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 11, color: C.GOLD, textTransform: 'uppercase', letterSpacing: '1.5px', marginBottom: 12, fontWeight: 600 }}>
                  Send Payment To (TRC20 Network)
                </div>
                <div style={{
                  background: C.DARK, border: `1px solid ${C.DARK3}`, borderRadius: 8,
                  padding: '12px 14px', fontFamily: "'Courier New', monospace", fontSize: 13,
                  color: C.GOLD, wordBreak: 'break-all', lineHeight: 1.6, userSelect: 'all',
                  marginBottom: 12,
                }}>
                  {CRYPTO_ADDRESS}
                </div>
                <button onClick={handleCopyAddress} style={{
                  padding: '8px 20px', background: `${C.GOLD}15`, border: `1px solid ${C.GOLD}40`,
                ...
                <div style={{
                  marginTop: 12, fontFamily: "'DM Sans', sans-serif", fontSize: 11,
                  color: '#E74C3C', lineHeight: 1.5,
                }}>
                  ⚠ Send only USDT on TRC20 (Tron) network. Wrong network = permanent loss.
                </div>
              </div>
            )}
