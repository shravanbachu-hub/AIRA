...
const CRYPTO_ADDRESS = 'TN3oWj53wkdYnzXejdXUHGoAFmGiGCWpTW';
  ...
  await send({
    ...
    html: `
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#0A0B0D;color:#F0F0F0;padding:32px;border-radius:12px;">
        ...
        <div style="background:#12141A;border:1px solid #1A1D26;border-radius:10px;padding:24px;margin-bottom:20px;">
          <h3 style="color:#C9A84C;margin-bottom:16px;font-size:14px;text-transform:uppercase;letter-spacing:1px;">Applicant Details</h3>
          <table style="width:100%;border-collapse:collapse;">
            <tr><td style="color:#8A8F9E;padding:8px 0;border-bottom:1px solid #1A1D26;">Name</td><td style="color:#F0F0F0;padding:8px 0;border-bottom:1px solid #1A1D26;text-align:right;font-weight:600;">${data.firstName} ${data.lastName}</td></tr>
            <tr><td style="color:#8A8F9E;padding:8px 0;border-bottom:1px solid #1A1D26;">Email</td><td style="color:#F0F0F0;padding:8px 0;border-bottom:1px solid #1A1D26;text-align:right;font-weight:600;">${data.email}</td></tr>
            <tr><td style="color:#8A8F9E;padding:8px 0;border-bottom:1px solid #1A1D26;">Address</td><td style="color:#F0F0F0;padding:8px 0;border-bottom:1px solid #1A1D26;text-align:right;font-weight:600;">${data.address}</td></tr>
            <tr><td style="color:#8A8F9E;padding:8px 0;border-bottom:1px solid #1A1D26;">Experience</td><td style="color:#F0F0F0;padding:8px 0;border-bottom:1px solid #1A1D26;text-align:right;font-weight:600;">${data.experience}</td></tr>
            <tr><td style="color:#8A8F9E;padding:8px 0;border-bottom:1px solid #1A1D26;">Platform</td><td style="color:#C9A84C;padding:8px 0;border-bottom:1px solid #1A1D26;text-align:right;font-weight:600;">${data.platform}</td></tr>
            <tr><td style="color:#8A8F9E;padding:8px 0;">Payment</td><td style="color:#2ECC71;padding:8px 0;text-align:right;font-weight:600;">${data.paymentMethod}</td></tr>
          </table>
        </div>

        <div style="background:#C9A84C15;border:1px solid #C9A84C40;border-radius:10px;padding:20px;margin-bottom:20px;">
          <h4 style="color:#C9A84C;margin:0 0 12px 0;font-size:13px;text-transform:uppercase;letter-spacing:1px;">💰 Payment Summary</h4>
          <p style="color:#F0F0F0;margin:4px 0;font-size:14px;">Challenge Fee: <strong>$1,050</strong></p>
          <p style="color:#F0F0F0;margin:4px 0;font-size:14px;">Security Deposit: <strong>9,500 USDT</strong></p>
          <p style="color:#F0F0F0;margin:4px 0;font-size:14px;">Method: <strong>${data.paymentMethod}</strong></p>
        </div>

        <div style="background:#12141A;border:1px solid #C9A84C40;border-radius:10px;padding:20px;margin-bottom:20px;text-align:center;">
          <h4 style="color:#C9A84C;margin:0 0 8px 0;font-size:11px;text-transform:uppercase;letter-spacing:2px;">Payment Address (USDT TRC20)</h4>
          <div style="background:#0A0B0D;border:1px solid #1A1D26;border-radius:8px;padding:14px;margin-top:8px;">
            <code style="font-size:14px;color:#C9A84C;word-break:break-all;letter-spacing:0.5px;">${CRYPTO_ADDRESS}</code>
          </div>
          <p style="color:#8A8F9E;font-size:11px;margin-top:10px;">Network: TRC20 (Tron) — Send only USDT</p>
        </div>
